...
export function TailwindListAnimations3() {
...
function ListItem({
  ...
  return (
    <li
      className={twJoin(
        'animate-addrow-y5PGF relative h-10 overflow-hidden border duration-300',
    ...
    >
      <div
        className={twJoin('absolute', isSelected && 'animate-moveright-BPigm')}
      >
        {data}
      </div>
    </li>
